...
- [client-server-separation-procedure.md](../../3_done/client-server-separation-procedure.md)（未実施項目は [client-server-separation-future.md](../plan/reference/client-server-separation-future.md)）
