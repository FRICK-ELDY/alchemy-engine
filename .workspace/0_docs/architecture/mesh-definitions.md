...
> 作成日: 2026-03-07  
> 出典: [legacy_contents-defines-rust-executes.md](../../1_backlog/legacy_contents-defines-rust-executes.md) P3-1  
...
| `.workspace/0_docs/architecture/draw-command-spec.md` | DrawCommand タグ・フィールド仕様 |
