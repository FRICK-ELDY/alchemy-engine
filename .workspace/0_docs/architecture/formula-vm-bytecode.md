...
- [formula-hardcode-inventory.md](../../2_todo/formula-hardcode-inventory.md) — ハードコード一覧（P1-1）
- [formula-migration-evaluation.md](../../2_todo/formula-migration-evaluation.md) — 武器式の Formula 移行評価（P1-2）
