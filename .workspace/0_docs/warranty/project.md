...
| **.workspace/0_docs/**    | 設計・タスク・評価ドキュメント  | 設計意図の記録                          | 実装の完了。将来の変更への追従         |
...
| ------------------------- | ---------------- | ---------- |
| `.workspace/0_docs/vision.md`          | 設計思想・保証範囲の記述     | 実装の完全な反映   |
| `.workspace/0_docs/warranty/ci.md`     | CI 手順・スクリプト説明    | スクリプトの将来互換 |
...
- **保証するもの**: 上記の検証手段を通過した範囲。設計ドキュメント（`.workspace/0_docs/vision.md` 等）に明記された契約。
