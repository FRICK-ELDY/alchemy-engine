...
> 作成日: 2026-03-16  
> 参照: [scene-origin-and-landing-reference-plan.md](scene-origin-and-landing-reference-plan.md), [scene-and-object.md](../0_docs/architecture/scene-and-object.md)  
...
| [scene-and-object.md](../0_docs/architecture/scene-and-object.md) | Scene の責務と state 規約（origin・着地点参照）。 |
