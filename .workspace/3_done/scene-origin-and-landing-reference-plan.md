...
> 作成日: 2026-03-16  
> 参照: [scene-and-object.md](../0_docs/architecture/scene-and-object.md), [scene-concept-addition-plan.md](scene-concept-addition-plan.md)  
...
| ドキュメント | 役割 |
|--------------|------|
| [scene-and-object.md](../0_docs/architecture/scene-and-object.md) | Scene と Object の責務。実施後は origin / 着地点参照の規約を記載。 |
| [scene-concept-addition-plan.md](scene-concept-addition-plan.md) | Scene 概念追加時の決定（root_object 必須化）。本計画で方針を発展させる。 |
...
- [x] .workspace/0_docs/architecture/scene-and-object.md が origin と着地点参照の規約に更新されている
- [x] .workspace/0_docs/architecture/fix_contents.md の Scene 記述が更新されている
