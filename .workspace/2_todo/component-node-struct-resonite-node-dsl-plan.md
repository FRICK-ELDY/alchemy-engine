...
- アーキテクチャの全体像は [fix_contents.md](../0_docs/architecture/fix_contents.md)（Node-Port-Link、Component とシーンの関係）に従う。
...
- [fix_contents.md](../0_docs/architecture/fix_contents.md) — fix_contents アーキテクチャ
